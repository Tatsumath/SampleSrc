...
// CStaticTestDlg.cpp : 実装ファイル
//

#include "pch.h"
#include "framework.h"
#include "CStaticTest.h"
#include "CStaticTestDlg.h"
...
CCStaticTestDlg::CCStaticTestDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_CSTATICTEST_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CCStaticTestDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
...
BOOL CCStaticTestDlg::OnInitDialog()
{
	...
	pStatic->ShowWindow(SW_SHOW);	//表示

	//pStatic->EnableWindow(FALSE);	//非活性
	pStatic->EnableWindow(TRUE);	//活性
...
void CCStaticTestDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  システムがこの関数を呼び出します。
HCURSOR CCStaticTestDlg::OnQueryDragIcon()
{
